    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fields', models.ManyToManyField(to='user.field')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('applicants', models.ManyToManyField(related_name='topic_request_applicants', to=settings.AUTH_USER_MODEL)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='academic.course')),
                ...
                ('fields', models.ManyToManyField(to='user.field')),
                ('supervisors', models.ManyToManyField(related_name='topic_request_supervisors', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_on', models.DateTimeField(blank=True, null=True)),
                ('approvee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('topic_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.topicrequest')),
            ],
        ),
    ]
