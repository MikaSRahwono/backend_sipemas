    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website_url', models.CharField(blank=True, max_length=256)),
                ('is_open', models.BooleanField(default=True)),
                ('experiences', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=256), blank=True, default=list, size=None)),
                ('fields', models.ManyToManyField(blank=True, related_name='field_of_interest', to='marketplace.field')),
